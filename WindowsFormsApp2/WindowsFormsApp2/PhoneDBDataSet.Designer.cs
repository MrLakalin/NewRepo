...
namespace WindowsFormsApp2.PhoneDBDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`ID` = ?) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (" +
                "`PhoneNumber` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`PhoneNumber`, `Password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `PhoneNumber` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = " +
                "1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Password` " +
                "IS NULL) OR (`Password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp2.Properties.Settings.Default.PhoneDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, PhoneNumber, [Password] FROM Users";
        ...
        public virtual int Fill(PhoneDBDataSet.UsersDataTable dataTable) {
        ...
        public virtual PhoneDBDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PhoneDBDataSet.UsersDataTable dataTable = new PhoneDBDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PhoneDBDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_PhoneNumber, string Original_Password) {
        ...
        public virtual int Update(string PhoneNumber, string Password, int Original_ID, string Original_PhoneNumber, string Original_Password) {
            if ((PhoneNumber == null)) {
                throw new global::System.ArgumentNullException("PhoneNumber");
            }
            else {
